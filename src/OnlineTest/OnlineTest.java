...
public	OnlineTest(String s)
	...
	void set()
	{
		...
		if(current==0)
		{
			l.setText("Que1: Which one among these is not a KEYWORD");
			jb[0].setText("INT");jb[1].setText("CHAR");jb[2].setText("CLASS");jb[3].setText("FLOAT");	
		}
		if(current==1)
		{
		...
		if(current==4)
		{
			...
			jb[0].setText("Disha");jb[1].setText("Atlanta");jb[2].setText("Unisoft");jb[3].setText("Samarth Acadmey");
		}
		if(current==5)
		{
